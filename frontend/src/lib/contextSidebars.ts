...
const ADMIN_CONTEXT: ContextSidebarDefinition = {
  ...
  groups: [
    ...
    },
    {
      ...
      label: 'Server tools',
      items: [
        { key: 'full-users', href: '/admin/view', label: 'Full user table & restrictions', icon: Table2, classic: true },
        { key: 'basic-config', href: '/admin/config', label: 'Basic configuration', icon: Settings, classic: true },
        { key: 'display-config', href: '/admin/viewconfig', label: 'UI / display configuration', icon: SlidersHorizontal, classic: true },
        { key: 'database-config', href: '/admin/dbconfig', label: 'Database & library path', icon: Database, classic: true },
        { key: 'scheduled-tasks', href: '/admin/scheduledtasks', label: 'Scheduled tasks', icon: Clock, classic: true },
        { key: 'cwa-settings', href: '/cwa-settings', label: 'CWA settings (ingest/convert)', icon: Server, classic: true },
        { key: 'duplicate-settings', href: '/cwa-settings#duplicate-detection', label: 'Duplicate detection settings', icon: Files, classic: true },
        { key: 'statistics', href: '/cwa-stats-show', label: 'Statistics dashboard', icon: BarChart3, classic: true },

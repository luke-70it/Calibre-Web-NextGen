...
At this revision the derived set is 151 of 218 local Python modules (this branch adds `cps/user_library.py` and `cps/user_preferences.py`; the closure correctly picks both up from request paths). Measured at `origin/main`
